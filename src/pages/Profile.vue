    ...
    <v-ons-card>
      ...
      <div class="content">
        <div style="text-align: center; margin-top: 30px">
          <p>
            Phone No : 09 498628998 <br>
            Password : ********* <br>
            Status : Premium Account <br>
            Experial Date :28, June 2019
          </p>
<!-- 
      <v-ons-button modifier="cta" class="button-margin" >
        <div class="left">
            <v-ons-icon fixed-width class="list-item__icon" :icon="ion-edit"></v-ons-icon>
          </div>
        Call to action
      </v-ons-button>
 -->
